...
**Live site:** https://shex1627.github.io/wow-rotation-tools/.
...
docs/
  ...
  frost-dk/
    ...
    rotation-quiz.html          # interactive "what do I press next" quiz
```
...
### Rotation quiz
- Laid out like the in-game cooldown manager: buffs row, rune grid, Runic Power bar, and an ability row with resource shading and WoW-style tooltips.
...
2. For a quiz: copy `frost-dk/rotation-quiz.html` as the template. The pieces to replace:
   ...
   - `COST` — the spec's resource model.
